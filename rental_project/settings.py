...
MIDDLEWARE = [
    ...
    'rental.middleware.AdminAccessMiddleware'
]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'smart_search.log',
        },
        'console': {
            'level': 'INFO',
...
OPENAI_API_KEY = os.environ.get('OPENAI_API_KEY', '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')
